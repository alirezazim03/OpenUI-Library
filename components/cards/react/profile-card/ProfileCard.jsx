      ...
      <div className="flex flex-col items-center text-center">
        ...
        <div className="relative mb-6">
          <div className="w-28 h-28 rounded-full ring-3 ring-yellow-600/20 p-1 transition-all duration-300 group-hover:scale-110">
            <img
              src="https://t4.ftcdn.net/jpg/03/96/16/79/360_F_396167959_aAhZiGlJoeXOBHivMvaO0Aloxvhg3eVT.jpg"
        ...
        {/* Name */}
        <h3 className="font-bold text-2xl mb-3 text-white">Abhijeet Singh</h3>
