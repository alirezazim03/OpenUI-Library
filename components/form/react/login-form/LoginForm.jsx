    ...
    <div className={`max-w-md mx-auto bg-white p-8 rounded-lg shadow-lg ${className}`}>
      ...
      <div className="mt-4">
        ...
        <button
          ...
          className="mt-4 w-full bg-white text-gray-700 py-2 px-4 rounded-md border border-gray-300 hover:bg-gray-50 focus:outline-none focus:ring-2 focus:ring-blue-500 transition-colors flex items-center justify-center"
        >
